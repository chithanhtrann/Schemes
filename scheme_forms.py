...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        bind_value = scheme_eval(expressions.rest.first, env)
        env.define(signature, bind_value)
        return signature
        # END PROBLEM 4
        ...
        env.define(function_name, lambda_procedure)
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        values = Pair(scheme_eval(expr, env), values)
